...
class Joueur:
    ...
    def __init__(self, canvas, x, y, score, vie, size = 30, speed=5):
        ...
        self.vaisseau_id = canvas.create_polygon(points, fill="purple", outline="black", width=2)
    ...
    def move(self, dx):
        ...
        self.canvas.move(self.vaisseau_id, dx, 0)
